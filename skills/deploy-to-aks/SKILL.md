...
|-------|------|-----------|
| Quick Deploy | `phases/quick-deploy.md` | `reference/detection.md`, `knowledge-packs/frameworks/<detected>.md` (if exists), `reference/safeguards.md`, `reference/workload-identity.md` |
...
| Phase | Read | Also load |
|-------|------|-----------|
| 1. Discover | `phases/01-discover.md` | `reference/detection.md`, `knowledge-packs/frameworks/<detected>.md` (if exists); `reference/aks-automatic.md` or `reference/aks-standard.md` based on AKS flavor choice |
...
| 6. Deploy | `phases/06-deploy.md` | `reference/rollback.md`, `templates/mermaid/summary-dashboard.md` |
